...
float AGENTSIZE = RADIUS*2;
float d_h = RADIUS*2*4;
float vx[100], vy[100], vx_goal[100], vy_goal[100];
//float f_goal_x[100], f_goal_y[100];
float f_goal_x, f_goal_y;
